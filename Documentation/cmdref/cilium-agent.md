...
```
      ...
      --auto-create-cilium-node-resource           Automatically create CiliumNode resource for own node on startup
  ...
  -e, --docker string                              Path to docker runtime socket (DEPRECATED: use container-runtime-endpoint instead) (default "unix:///var/run/docker.sock")
      ...
      --enable-host-reachable-services             Enable reachability of services for host applications (beta) (default true)
